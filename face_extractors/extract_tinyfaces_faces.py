...
def full_img_with_boxes(full_img,boxes, counter):
...
def evaluate(weight_file_path, data_dir, prob_thresh=0.5, nms_thresh=0.1, lw=3, display=False):
  ...
  with tf.Session() as sess:
    ...
    detected_faces = full_img_with_boxes(data_dir,refined_bboxes, facecount)
...
# def create_tinyFaces_network_Params(args):
  ...
  with tf.Graph().as_default():
    return evaluate(
      weight_file_path=args.weight_file_path, data_dir=frame,

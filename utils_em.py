...
def draw_text(image, text, color, x_offset=0, y_offset=0,font_scale=2, thickness=2):
# def draw_text(image, coordinates, text, color, x_offset=0, y_offset=0,font_scale=2, thickness=2):
    x, y = (50,60)
    # x, y = coordinates[:2]

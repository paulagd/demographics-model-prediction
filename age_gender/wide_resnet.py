...
class WideResNet:
    def __init__(self, image_size, depth=16, k=8, units_age=101):
        self._depth = depth
        self._units_age = units_age
        self._k = k
...
#    def create_model(self):
    def __call__(self):
        ...
        predictions_a = Dense(units=self._units_age, kernel_initializer=self._weight_init, use_bias=self._use_bias,
                              kernel_regularizer=l2(self._weight_decay), activation="softmax")(flatten)
